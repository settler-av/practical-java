...
public class ATM {
    ...
    void runATM() {
        //PART_II_OOP.II_to_IV_banking.ATM  = new PART_II_OOP.II_to_IV_banking.ATM();
        int choice;
        ...
        do {
            System.out.println("\n`````````````````````````````````````````````````````\n" +
                               ...
                               "3. Deposit money\n" +
                               "4. Money Transfer\n" +
                               "5. Create PART_II_OOP.II_to_IV_banking.Account\n" +
                               "6. Deactivate PART_II_OOP.II_to_IV_banking.Account\n" +
                               "7. logout");
            System.out.print("\n`````````````````````````````````````````````````````\n" +
                             "Enter your choice : ");
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    //deactivate PART_II_OOP.II_to_IV_banking.Account
    ...
    void createAccount() {
        // Create PART_II_OOP.II_to_IV_banking.Account
    ...
    void userLogin() {
        ...
        if (userChoice == 1) {
            //login process
            System.out.println("Enter the PART_II_OOP.II_to_IV_banking.Account Number : ");
    ...
    void validateInput(int userInput, short attempts) {
        if (userInput > 0 && userInput < 11) {
            ...
            if (result == 'Y') {
                System.out.println("Enter the PART_II_OOP.II_to_IV_banking.Account Number (" + attempts + "try left): ");
